  ...
  <section id="project" class="projects">
    <div class="container" data-aos="fade-down" >
      ...
      <div class="card-deck">
        ...
        <div class="card glass" data-aos="flip-down" data-aos-duration="2000">
          <img src="assets/img/acheron.png" class="card-img-top project-img" alt="web">
          <div class="card-body">
            <p class="card-text">Project membuat website laundry.</p>
          </div>
        </div>
...
.glass {
  ...
  box-shadow: 0 8px 32px solid rgba(0, 0, 0, 0.37);;
}
